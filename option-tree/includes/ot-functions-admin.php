          ...
          array(
            ...
            'pages'               => array(
              array(
                ...
                'page_title'      => apply_filters( 'ot_theme_options_page_title', __( 'PlusPort Options', 'option-tree' ) ),
                'menu_title'      => apply_filters( 'ot_theme_options_menu_title', __( 'PlusPort Options', 'option-tree' ) ),
                ...
                'position'        => 29,
                                    //apply_filters( 'ot_theme_options_position', null ),
                ...
                'icon_url'        => get_template_directory_uri() . '/img/icons/pp_icon_admin.png'
              )
            )
          )
        )
...
if ( ! function_exists( 'ot_register_settings_page' ) ) {
  ...
  function ot_register_settings_page() {
    ...
    // Create the filterable pages array
	 // remove this option arrays to remove from dashboard menu
...
if ( ! function_exists( 'ot_admin_scripts' ) ) {
  ...
  function ot_admin_scripts() {
    ...
    $localized_array = array(
      ...
      'upload_text'           => apply_filters( 'ot_upload_text', __( 'Send to PlusPort Options', 'option-tree' ) ),
