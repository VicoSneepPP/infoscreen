...
if (function_exists('add_theme_support'))
{
    ...
    load_theme_textdomain('pplang', get_template_directory() . '/languages');
}
...
function register_html5_menu()
{
    register_nav_menus(array( // Using array to specify more menus if needed
        'header-menu' => __('Header Menu', 'pplang'), // Main Navigation
        'sidebar-menu' => __('Sidebar Menu', 'pplang'), // Sidebar Navigation
        'extra-menu' => __('Extra Menu', 'pplang') // Extra Navigation if needed (duplicate as many as you need!)
    ));
}
...
if (function_exists('register_sidebar'))
{
    ...
    register_sidebar(array(
        'name' => __('Widget Area 1', 'pplang'),
        'description' => __('Description for this widget-area...', 'pplang'),
        'id' => 'widget-area-1',
...
{
    global $post;
    return '... <a class="view-article" href="' . get_permalink($post->ID) . '">' . __('View Article', 'pplang') . '</a>';
}
...
function pplanggravatar ($avatar_defaults)
{
...
function pplangcomments($comment, $args, $depth)
{
...
// Add Actions
add_action('init', 'pp_header_scripts'); // Add Custom Scripts to wp_head
add_action('wp_print_scripts', 'pp_conditional_scripts'); // Add Conditional Page Scripts
